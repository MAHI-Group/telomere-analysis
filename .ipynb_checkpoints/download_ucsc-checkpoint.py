...
# Literature positions (1295113, 1295135) are 1-based (COSMIC/Ensembl convention);
# UCSC REST returns 0-based half-open sequence. The minus-strand index for a
# 1-based genomic position g is (END - g), where END is the 0-based end-exclusive.
